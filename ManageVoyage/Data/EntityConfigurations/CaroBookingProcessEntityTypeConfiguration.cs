...
public class CaroBookingProcessEntityTypeConfiguration : IEntityTypeConfiguration<CaroBookingProcess>
{
    public void Configure(EntityTypeBuilder<CaroBookingProcess> entityTypeBuilder)
    {
        ...
        entityTypeBuilder.HasKey(p => p.PhoneCustomer);
        ...
        entityTypeBuilder.Property(p => p.UpdatedByUser).HasColumnType("NVARCHAR(50)").UseCollation("Latin1_General_CI_AI"); ;
        ...
        entityTypeBuilder.Property(p => p.FullName).HasColumnType("NVARCHAR(150)").UseCollation("Latin1_General_CI_AI"); ;
    }
}